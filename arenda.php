<?php
	...
	if(empty($errors)){
		...
		$message .= "Кол-во "			. $_POST['num'] . "<br />";
		$message .= "Срок "			. $_POST['srok'] . "<br />";
		$message .= "Срочная доставка"			. $_POST['fast'] . "<br />";
		$message .= "В подарок: Масляный обогреватель, мебель, двухъярусные кровати "			. $_POST['gift'] . "<br />";
...
$roistatData = array(
    ...
    'comment' =>'
		Кол-во '														 . $_POST['num'] . '<br />
		Срок '															 . $_POST['srok'] . '<br />
		Срочная доставка '												 . $_POST['fast'] . '<br />
		В подарок: Масляный обогреватель, мебель, двухъярусные кровати '. $_POST['gift'] . '',
    'name'    => '',
    'phone'   => $_POST['p'],
