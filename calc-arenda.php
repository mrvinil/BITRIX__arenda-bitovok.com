<?php
	...
	if(empty($errors)){
		...
		$message   = "Что интересует: " 	. $_POST['title'] . "<br/>";
		$message  .= "Телефон: " 			. $_POST['p'] . "<br/>";
		$message  .= "Коммент: " 					.$_POST['comment'] . "<br />";
		$message  .= "Кол-во: " 					.$_POST['colvo'] . "<br />";
		$message  .= "Срок " 					.$_POST['srok'] . "<br />";
		$message  .= "Нужно быстро:  " 					.$_POST['fast'] . "<br />";
		$message  .= "Хочет подарок " 					.$_POST['gift'] . "<br />";
...
$roistatData = array(
    ...
    'title'   => 'Заявка на аренду - ' .$_POST['title'],
    'comment' =>
    		'Коммент: '			.$_POST['comment'] . '<br />
			Кол-во: '			.$_POST['colvo'] . '<br />
			Срок: '				.$_POST['srok'] . '<br />
			Нужно быстро: '		.$_POST['fast'] . '<br />
			Хочет подарок'		.$_POST['gift'] . '<br />',
    'name'    => '',
    'phone'   => $_POST['p'],
