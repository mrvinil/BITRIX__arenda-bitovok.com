...
<section class="section" id="contacts-bottom">
	<div class="container">
		<div class="row">
			<div class="col-4">
				<p>Адрес:</p>
				<p><b><span>г. Москва, ул. Вишнёвая, дом 9 корп 1</span></b></p>
			</div>
			<div class="col-4">
				<p>Телефон:</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-3">
					<a href="/v-aprelevke/">Апрелевка</a>
					<a href="/v-balashihe/">Балашиха</a>
					<a href="/v-bronnitsah/">Бронницы</a>
					<a href="/v-chehove/">Чехов</a>
					<a href="/v-dedovske/">Дедовск</a>
					<a href="/v-dolgoprudnom/">Долгопрудный</a>
					<a href="/v-domodedovo/">Домодедово</a>
					<a href="/v-dzerzhinskom/">Дзержинский</a>
					<a href="/v-egorevske/">Егорьевск</a>
					<a href="/v-elektrostali/">Электросталь</a>
					<a href="/v-elektrouglyah/">Электроугли</a>
				</div>
				<div class="col-md-6 col-lg-3">
					<a href="/v-golitsyno/">Голицыно</a>
					<a href="/v-himkah/">Химки</a>
					<a href="/v-istre/">Истра</a>
					<a href="/v-ivanteevke/">Ивантеевка</a>
					<a href="/v-klimovske/">Климовск</a>
					<a href="/v-kolomne/">Коломна</a>
					<a href="/v-koroleve/">Королев</a>
					<a href="/v-kotelnikah/">Котельники</a>
					<a href="/v-krasnogorske/">Красногорск</a>
					<a href="/v-krasnoznamenske/">Краснознаменск</a>
					<a href="/v-lobne/">Лобня</a>
				</div>
				<div class="col-md-6 col-lg-3">
					<a href="/v-losino-petrovskom/">Лосино-Петровский</a>
					<a href="/v-lytkarino/">Лыткарино</a>
					<a href="/v-lyubertsah/">Люберцы</a>
					<a href="/v-mozhajske/">Можайск</a>
					<a href="/v-mytishhah/">Мытищи</a>
					<a href="/v-naro-fominske/">Наро-Фоминск</a>
					<a href="/v-noginske/">Ногинск</a>
					<a href="/v-odintsovo/">Одинцово</a>
					<a href="/v-podolske/">Подольск</a>
					<a href="/v-pushkino/">Пушкино</a>
					<a href="/v-ramenskom/">Раменское</a>
				</div>
				<div class="col-md-6 col-lg-3">
					<a href="/v-reutove/">Реутов</a>
					<a href="/v-serpuhove/">Серпухов</a>
					<a href="/v-shhelkovo/">Щелково</a>
					<a href="/v-shherbinke/">Щербинка</a>
					<a href="/v-staroj-kupavne/">Старая Купавна</a>
					<a href="/v-troitske/">Троицк</a>
					<a href="/v-vidnom/">Видное</a>
					<a href="/v-yubilejnom/">Юбилейный</a>
					<a href="/v-zelenograde/">Зеленоград</a>
					<a href="/v-zheleznodorozhnom/">Железнодорожный</a>
					<a href="/v-zhukovskom/">Жуковский</a>
					<a href="/vo-fryazino/">Фрязино</a>
				</div>
			</div>
		</div>
	</section>
				...
				<div class="form-product-modal-1 row">
					...
					<div class="col-6 product-modal-right">
						...
						<div class="row product-arenda-form justify-content-center">
							...
							<div class="col-6">
								<div class="input-col">
									<input id="product_phone" type="number" class="arenda-phone-field phone-field"
...
<script src="/local/templates/regions/assets/js/wow.min.js"></script>
<!--     <script src="/js/jquery.animateNumber.min.js"></script> -->

<script src="/local/templates/regions/assets/js/accordion.js"></script>
<script src="/local/templates/regions/assets/js/jquery.viewportchecker.min.js"></script>
<script src="/local/templates/regions/assets/js/jquery.inputmask.js"></script>
<script src="/local/templates/regions/assets/js/jquery.inputmask.numeric.extensions.js"></script>
<script src="/local/templates/regions/assets/js/main.js"></script>
<script>
	new WOW().init();
</script>
...
<?$APPLICATION->IncludeFile(
	SITE_DIR."/include/yandexMetrika.php",
	Array(),
	Array("MODE"=>"php")
);?>
