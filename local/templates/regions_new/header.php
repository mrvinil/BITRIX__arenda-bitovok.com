...
$cities = array(
	'v-aprelevke' => array('Апрелевка', 'Апрелевке', 'Апрелевку'),
	'v-balashihe' => array('Балашиха', 'Балашихе', 'Балашиху'),
	'v-bronnitsah' => array('Бронницы', 'Бронницах', 'Бронницы'),
	'v-vidnom' => array('Видное', 'Видном', 'Видное'),
	'v-golitsyno' => array('Голицыно', 'Голицыно', 'Голицыно'),
	'v-dedovske' => array('Дедовск', 'Дедовске', 'Дедовск'),
	'v-dzerzhinskom' => array('Дзержинский', 'Дзержинском', 'Дзержинский'),
	'v-dolgoprudnom' => array('Долгопрудный', 'Долгопрудном', 'Долгопрудный'),
	'v-domodedovo' => array('Домодедово', 'Домодедово', 'Домодедово'),
	'v-egorevske' => array('Егорьевск', 'Егорьевске', 'Егорьевск'),
	'v-zheleznodorozhnom' => array('Железнодорожный', 'Железнодорожном', 'Железнодорожный'),
	'v-zhukovskom' => array('Жуковский', 'Жуковском', 'Жуковский'),
	'v-zelenograde' => array('Зеленоград', 'Зеленограде', 'Зеленоград'),
	'v-ivanteevke' => array('Ивантеевка', 'Ивантеевке', 'Ивантеевку'),
	'v-istre' => array('Истра', 'Истре', 'Истру'),
	'v-klimovske' => array('Климовск', 'Климовске', 'Климовск'),
	'v-kolomne' => array('Коломна', 'Коломне', 'Коломну'),
	'v-koroleve' => array('Королев', 'Королеве', 'Королев'),
	'v-kotelnikah' => array('Котельники', 'Котельниках', 'Котельники'),
	'v-krasnogorske' => array('Красногорск', 'Красногорске', 'Красногорск'),
	'v-krasnoznamenske' => array('Краснознаменск', 'Краснознаменске', 'Краснознаменск'),
	'v-lobne' => array('Лобня', 'Лобне', 'Лобню'),
	'v-losino-petrovskom' => array('Лосино-Петровский', 'Лосино-Петровском', 'Лосино-Петровский'),
	'v-lytkarino' => array('Лыткарино', 'Лыткарино', 'Лыткарино'),
	'v-lyubertsah' => array('Люберцы', 'Люберцах', 'Люберцы'),
	'v-mozhajske' => array('Можайск', 'Можайске', 'Можайск'),
	'v-mytishhah' => array('Мытищи', 'Мытищах', 'Мытищи'),
	'v-naro-fominske' => array('Наро-Фоминск', 'Наро-Фоминске', 'Наро-Фоминск'),
	'v-noginske' => array('Ногинск', 'Ногинске', 'Ногинск'),
	'v-odintsovo' => array('Одинцово', 'Одинцово', 'Одинцово'),
	'v-podolske' => array('Подольск', 'Подольске', 'Подольск'),
	'v-pushkino' => array('Пушкино', 'Пушкино', 'Пушкино'),
	'v-ramenskom' => array('Раменское', 'Раменском', 'Раменское'),
	'v-reutove' => array('Реутов', 'Реутове', 'Реутов'),
	'v-serpuhove' => array('Серпухов', 'Серпухове', 'Серпухов'),
	'v-staroj-kupavne' => array('Старая Купавна', 'Старой Купавне', 'Старую Купавну'),
	'v-troitske' => array('Троицк', 'Троицке', 'Троицк'),
	'vo-fryazino' => array('Фрязино', 'Фрязино', 'Фрязино'),
	'v-himkah' => array('Химки', 'Химках', 'Химки'),
	'v-chehove' => array('Чехов', 'Чехове', 'Чехов'),
	'v-shhelkovo' => array('Щелково', 'Щелково', 'Щелково'),
	'v-shherbinke' => array('Щербинка', 'Щербинке', 'Щербинку'),
	'v-elektrostali' => array('Электросталь', 'Электростали', 'Электросталь'),
	'v-elektrouglyah' => array('Электроугли', 'Электроуглях', 'Электроугли'),
	'v-yubilejnom' => array('Юбилейный', 'Юбилейном', 'Юбилейный')
);
