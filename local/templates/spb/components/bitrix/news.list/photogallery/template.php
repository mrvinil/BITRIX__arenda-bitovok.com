...
// Фильтруем элементы и выбираем только тот, у которого название "Фото для Питера"
$moscowItem = null;
foreach($arResult["ITEMS"] as $arItem) {
	if($arItem["NAME"] == "Фото для Питера") {
		$moscowItem = $arItem;
		break;
	}
}

// Проверяем, что элемент с названием "Фото для Питера" найден
if($moscowItem) {
	$uniqueTags = [];
